...
public class MemberDao {
	...
	public int insertMember(Connection conn, Member m) {
		...
		int result = 0;
		String query = "insert into member_tbl values(" + "member_seq.nextval," + "?,?,?,?,?,3,"
	...
	public Member searchIdMember(Connection conn, String memberId) {
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		Member m = null;
		String query = "select * from member_tbl where member_id = ?";
...
//				m = new Member(memberNo, memberId2, memberPW, memberName, memberPhone, memberAddr, memberLevel,
//						enrollDate);
//			}
			while (rset.next()) {
				m = new Member();
