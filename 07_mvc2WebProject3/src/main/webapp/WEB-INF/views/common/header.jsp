...
<header>
	...
	<div class="header-link">
		...
		if (m == null) {
		%>
		<button class="btn bc11 modal-open-btn" target="#login-modal">SIGN
			IN</button>
		<a class="btn bc11" href="/joinFrm.do">SIGN UP</a>
		<%
		} else {
		%>
	...
	<div class="modal-wrap">
		...
		<form action="/signIn.do" method="post">
			<div class="modal-content">
				<div class="input-box">
					<label for="signId">아이디</label> <input type="text" name="signId"
						class="input-form" placeholder="아이디입력">
				</div>
				<div class="input-box">
					<label for="signPw">비밀번호</label> <input type="password"
						name="signPw" class="input-form" placeholder="비밀번호입력">
				</div>
