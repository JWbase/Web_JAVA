		...
		<form action="/updateMember.do" method="post" name="updateFrm">
			<div class="input-wrap">
				<label for="memberId">아이디</label> <input type="text" name="memberId"
					id="memberId" class="input-form" value="<%=member.getMemberId()%>"
					disabled>
			</div>
			<div class="input-wrap">
			...
			<div class="input-wrap">
				...
				<input type="text" name="memberLevel" id="memberLevel"
					class="input-form" value="관리자" disabled>
				<%
				} else if (member.getMemberLevel() == 2) {
				%>
				<input type="text" name="memberLevel" id="memberLevel"
					class="input-form" value="정회원" disabled>
				<%
				} else if (member.getMemberLevel() == 3) {
				%>
				<input type="text" name="memberLevel" id="memberLevel"
					class="input-form" value="준회원" disabled>
				<%
				}
				%>
			</div>
			<div class="input-wrap">
				<label for="enrollDate">가입일</label> <input type="text"
					name="enrollDate" id="enrollDate" class="input-form"
			...
			<div class="btn-box">
				...
				%>
				<a class="btn bc66 bs2 " href=/deleteMember.do?<%=m.getMemberId()%>>회원탈퇴</a>
				<%
				}
				%>
			</div>
