 ...
 * Generated at: 2022-09-08 05:54:07 UTC
...
if (m == null) {
      ...
      out.write("			<input type=\"text\" name=\"postcode\" id=\"postcode\" class=\"input-form\"\r\n");
      out.write("				readonly>\r\n");
      out.write("			<button class=\"btn bc1\" onclick=\"searchAddr();\">주소찾기</button>\r\n");
      out.write("			<input type=\"text\" name=\"address\" id=\"address\" class=\"input-form\"\r\n");
      out.write("				readonly> <input type=\"text\" name=\"detailAddress\"\r\n");
      out.write("				id=\"detailAddress\" class=\"input-form\">\r\n");
      out.write("		</div>\r\n");
      out.write("		<hr>\r\n");
      ...
      out.write("			map : map\r\n");
      out.write("		});\r\n");
      out.write("		let contentString = [ \"<div class='iw_inner'>\", \"	<h3>KH정보교육원</h3>\",\r\n");
      out.write("				\"	<p>서울시 영등포구 선유동2로 57 이레빌딩 19F A강의장</p>\", \"</div>\" ].join(\"\");\r\n");
      ...
      out.write("			marker.setPosition(e.coord); // 해당위치로 마커이동\r\n");
      out.write("			if (infoWindow.getMap()) { //정보창이 지도위에 올라가\r\n");
      ...
      out.write("				//지도에서 사용할 위경도 위치객체\r\n");
      out.write("				const latlng = new naver.maps.LatLng(lat, lng);\r\n");
      out.write("				map.setCenter(latlng); // 지도중심 이동\r\n");
      out.write("				marker.setPosition(latlng); // 마커위치이동\r\n");
      out.write("\r\n");
      out.write("			})\r\n");
      out.write("		}\r\n");
      out.write("\r\n");
